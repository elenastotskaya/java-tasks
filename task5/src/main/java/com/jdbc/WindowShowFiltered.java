...
public class WindowShowFiltered {
    private static TableView<Product> table;
    public static void display(long priceMin, long priceMax) {
        ...
        ObservableList<Product> observableList = FXCollections.observableList(Main.commands.getList(priceMin, priceMax));
